module Prog
	...
	#    argument binding happens in backend/statement.code's `Self(;)` instead.
	class Statement < Instance
		...
		#
		# use_caller_scope/memoize/memoized/_memoized_value live in backend/statement.code as ordinary Backend
