...
require_relative '../../lang/lexer/tokenizer'
require_relative '../../lang/lexer/errors'


class Tokenizer_Test < Minitest::Test

	class Modified_Tokenizer < Tokenizer # to allow writing to subset of attrs, since these are declared as attr_readers in Tokenizer
		attr_writer :i, :col, :row, :input
	end

	def setup
		@lexer = Modified_Tokenizer.new
	end
	...
	# @yieldparam [Array<Token>] output Array of tokens generated by the tokenizer
	# @return [Array<Token>] Array of tokens generated by the tokenizer
	def lex input
