...
class Interpreter_Test < Minitest::Test
	...
	def test_boolean_logic
		...
		refute interp 'true && false'
		assert interp 'true and true'
		refute interp 'true and false'
	end
	...
	def test_sanity
		skip "Using += in a function body doesn't seem to be able to find the left hand side."
