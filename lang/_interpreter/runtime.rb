...
# 	# endregion Scopes
#
# <<<<<<<< Updated upstream:lang/_runtime/_runtime.rb
# 	# This is the meat of the _runtime
# ========
# 	# This is the meat of the _interpreter
# >>>>>>>> Stashed changes:lang/_interpreter/_runtime.rb
#
...
# 				return receiver.dup.tap do |kopy|
# 					kopy[SCOPE_KEY_TYPE] = receiver[SCOPE_KEY_TYPE] #.gsub('Static', 'Instance') # receiver[CONTEXT_SYMBOL] # Instance.name
# 					kopy.each do |key, val|
