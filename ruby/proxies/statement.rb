module Code
	...
	#    argument binding happens in lang/statement.code's `Self(;)` instead.
	class Statement < Instance
		...
		#
		# use_caller_scope/memoize/memoized/_memoized_value live in lang/statement.code as ordinary Code
